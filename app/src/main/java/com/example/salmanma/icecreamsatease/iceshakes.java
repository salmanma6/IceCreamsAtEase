...
public class iceshakes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Icecream Shakes");
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Icecream Shakes");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        recyclerview=(RecyclerView)findViewById(R.id.listspice);
        recyclerview.setHasFixedSize(true);
        layoutManager = new LinearLayoutManager(getApplicationContext());
        recyclerview.setLayoutManager(layoutManager);
        reference=FirebaseDatabase.getInstance().getReference().child("products").child("type").child("icecreamshakes");
